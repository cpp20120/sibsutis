...
ChessGame::ChessGame(sf::Color bordCol1 = sf::Color::White,
    sf::Color bordCol2 = sf::Color::Black)
    : board(bordCol1, bordCol2) {
    font.loadFromFile(
        "C:/Users/cppshizoid/Source/Repos/Chess/src/Textures/arial.ttf");
    ...
    textRestart.setPosition(infoRestart.getPosition().x + 75.f,
        infoRestart.getPosition().y + 10.f);
...
void ChessGame::calcPawnMoves(Piece* tmpPiece) {
    ...
    if (tmpPiece->getPlayer()) {
        if ((piecePos / 8) != 0) {
            ...
            tmpPiece->setPiece('Q', tmpPiece->getPlayer(), tmpPiece->getPosition(),
                true);
            calcQueenMoves(tmpPiece);
            return;
        }
