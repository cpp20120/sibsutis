...
int main() {
  ChessGame chess(sf::Color(0xf3bc7aff),
                  sf::Color(0xae722bff));  // Светло-жёлтый и темно коричневый

  sf::RenderWindow window(sf::VideoMode(770, 512), "Chess",
