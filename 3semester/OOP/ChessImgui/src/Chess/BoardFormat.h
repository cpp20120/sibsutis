...
std::basic_ostream<CharT, Traits>& BoardCoordinates(
...
template <typename CharT, typename Traits>
std::basic_ostream<CharT, Traits>& NoBoardCoordinates(
    std::basic_ostream<CharT, Traits>& os) {
...
template <typename CharT, typename Traits>
std::basic_ostream<CharT, Traits>& OrientationWhite(
    std::basic_ostream<CharT, Traits>& os) {
...
template <typename CharT, typename Traits>
std::basic_ostream<CharT, Traits>& OrientationBlack(
    std::basic_ostream<CharT, Traits>& os) {
