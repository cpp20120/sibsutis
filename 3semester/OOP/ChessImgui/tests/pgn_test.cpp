...
static bool TestLongAlgebraicMove() {
  Game game;
...
void TestStartingFenPosition() {
  ...
  std::string pgn =
      R"([FEN "r1bqk1nr/pppp1ppp/2n5/2b1p3/1PB1P3/5N2/P1PP1PPP/RNBQK2R b KQkq - 0 4"]
4... Bxb4
5. c3 Ba5
)";
  ...
  pgn =
      R"([FEN "r1bqkbnr/pppp1ppp/2n5/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq - 2 3"]
3. Bc4 Bc5 4. b4
)";
...
5. Nxd4 Bb4 6. Nxc6 bxc6 7. Bd3 O-O
    ...
    for (auto& move : mainLine) game2.Move(move);

    std::cout << "Position:\n" << game.GetPosition() << "\n";
    std::cout << "Game PGN:\n" << game2 << "\n";

         std::array<LongAlgebraicMove, 13> variation = {
        "f8c5", "c1e3", "c5b6", "d1d2", "d7d6", "f2f3", "d8e7",
        "e1c1", "c8d7", "f1c4", "e8c8", "d4c6", "d7c6",
    };

    std::cout << "Going back 9 moves...\n";
    for (int i = 0; i < 9; i++) game2.Back();

    std::cout << "Creating new variation...\n";
    for (auto& move : variation) game2.Move(move);
